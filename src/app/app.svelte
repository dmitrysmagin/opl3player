<script lang="ts">
  import Opl3Player from './lib/Opl3Player.svelte';
</script>
...
<div class="min-h-screen bg-slate-900 text-white">
  <div class="max-w-5xl mx-auto p-6 space-y-6">
    ...
    <div class="text-center text-slate-500 text-xs mt-8 flex flex-col items-center gap-2">
      <div>OPL3 Music Player • Svelte 5 + Vite + Tailwind CSS</div>
      <a href="https://github.com/dmitrysmagin/opl3player" target="_blank" rel="noopener noreferrer" 
